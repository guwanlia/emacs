...
(defun ac-cc-mode-setup ()
  (setq ac-sources (append '(ac-source-semantic ac-source-imenu ac-source-yasnippet) ac-sources))) ;;ac-source-features ac-source-functions ac-source-yasnippet ac-source-variables ac-source-symbols) ac-sources)))
  ;;(setq ac-sources (append '(ac-source-yasnippet ac-source-gtags) ac-sources)))
(defun ac-python-mode-setup()
  (setq ac-sources (append '(ac-source-imenu ac-source-yasnippet ac-source-ropemacs) ac-sources)))
